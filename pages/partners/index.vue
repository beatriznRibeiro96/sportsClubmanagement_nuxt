<template>
  <div>
    <b-container>
      ...
      <b-table responsive ref="selectableTable" bordered hover head-variant="dark" :items="partners" :fields="fields" :filter="filter" :filterIncludedFields="filterOn" sort-icon-left selectable select-mode="multi" @row-selected="onRowSelected">
